...
[](/guides/face/face-effects-overview)

#### Face Effects Overview

A general overview of each available Face Effect in Lens Studio used for
...
The Getting Started guide offers a great overview of Lens Studio

[](/guides/submission/submitting-your-lens)

#### Submitting Your Lens

The Submitting Your Lens guide shows how to submit and manage your
Lenses

[](/guides/sharing/sharing-your-lens)
...
[](/guides/general/segmentation)

#### Segmentation

Segmentation textures can be applied to a camera's input to show or hide
certain areas of the scene

[](/guides/general/tracking/marker-tracking)

#### Marker Tracking

Marker Tracking gives you the ability to a Lens which tracks content to
a unique physical image

[](/guides/face/face-effects/face-image-picker-texture)

#### Face Image Picker Texture

The Face Image Picker Texture allows you to get an image from your
device's camera roll centered around a face

[](/guides/2d/text)

#### Text

The Text component allows you to add dynamic text to your Lens
experience

[](/guides/face/face-effects/face-image)

#### Face Image

The Face Image object attaches a 2D textured plane to your head

[](/guides/face/face-effects/face-mask)

#### Face Mask

The Face Mask effect maps a 2D texture to your face that appears to be
painted on your skin

[](/guides/face/face-effects/face-stretch)

#### Face Stretch

The Face Stretch effect allows you to stretch points of the user's face
distorting its shape

[](/guides/general/panels)

#### Panels

The Panels guide highlights each panel's function in Lens Studio

[](/guides/general/toolbar-and-shortcuts)

#### Toolbar and Shortcuts

An overview of each tool in the Lens Studio's Toolbar and the available
keyboard shortcuts

[](/guides/general/pairing-to-snapchat)

#### Pairing to Snapchat

The Pairing to Snapchat guide specifies how to preview your Lens in
Snapchat as you work

[](/guides/3d/3d-object-export)

#### 3D Object Export

The 3D Object Export guide details how to export models for optimal use
in Lens Studio

[](/guides/3d/3d-object-import)

#### 3D Object Import

The 3D Object Import guide walks through how to import a 3D object into
Lens Studio
...
The Scripting Overview guide provides a broad overview of Lens Studio
scripting
...
The Materials guide offers an overview of each built-in Material, which
define how 3D objects are rendered

[](/guides/submission/performance-and-optimization)

#### Performance and Optimization

Performance requirements for submitting your lens alongside best
practices for optimization

[](/guides/submission/creating-an-icon)

#### Creating an Icon

The Creating an Icon guide provides Templates and best practices to help
you create a Lens icon
