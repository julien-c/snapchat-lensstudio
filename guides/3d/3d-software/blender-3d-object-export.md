...
![Blender](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/Guides/img/3d_animation_export_blender_intro.png)

This guide will walk through how to use Blender to export a 3D model to
the FBX format, so that it can be imported into Lens Studio. For the
purposes of this guide, we're using
[Blender 2.79](https://www.blender.org/). That said, any 3D tool that
can export to FBX should be able to export models that can be imported
into Lens Studio.
...
![Blender | Export
FBX](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/Guides/img/3d_object_export_blender_file_menu.png)
...
![Blender Settings |
Main](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/Guides/img/3d_object_export_blender_settings_main.png)
...
![Blender Settings |
Geometries](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/Guides/img/3d_object_export_blender_settings_geometries.png)
...
![Blender Settings |
Armatures](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/Guides/img/3d_object_export_blender_settings_armatures.png)
...
![Blender Settings |
Animation](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/Guides/img/3d_object_export_blender_settings_animation.png)

Select `Baked Animation` in the Animation tab and optionally these
twofollowing settings:

  - Key All Bones
  - Force Start/End Keying

**Tip  
** If your scene has multiple animation Actions (known in Lens Studio as
Animation Layers), you should check "All Actions" to ensure they
imported properly into Lens Studio.
...
To ensure that your model's textures are imported automatically to Lens
Studio, it's recommended that you save your textures in the same folder
as your exported FBX. For example, if your project is located at the
path:
...
**Tip   
**3D model textures should be square. The width and height of your
texture should be a power of 2 (e.g. 128, 256, 512 or 1024). If your
model has only one color try to lower the resolution to 8 x 8.
...
in Lens Studio, you should set the frame rate of your Blender scene to
30 frames per second.

You can set the frame rate in Blender under the scene settings in the
default view.

![Blender | Frame
Rate](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/Guides/img/3d_object_export_blender_frame_rate.png)
