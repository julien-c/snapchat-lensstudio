...
# ![Creating an Icon Example](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/Guides/img/creating_an_icon_world_example.png)

# Best Practices

The icon for a Lens should depict the content of the Lens in the most
simplistic way. Below are some best practices to use when creating your
Lens's icon:
  ...
  - Deliver icons as a 320x320 PNG and use the standard frame found in
    the icon template

# Photoshop Template

Download the Photoshop Lens icon template below to create your Lens'
icon.

#### [PHOTOSHOP - Lens Icon Template](http://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/lens_icon_template_photoshop.zip)

Open the template within Adobe Photoshop. Replace the content in the
layer labeled `[REPLACE ME]`. This will mask your content within a
circle. Additionally, you can tune the background color by adjusting the
`Color Overlay` effect on the `Color BG` layer.

![Creating an Icon
Layers](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/Guides/img/creating_an_icon_world_ps_layers.png)

To export your icon, select `File -> Export -> Export As...` and select
`PNG` as the export format.

![Creating an Icon
Export](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/Guides/img/creating_an_icon_world_ps_export.png)

## Illustrator Template

Download the Illustrator Lens icon template below to create your Lens's
icon.

#### [Illustrator - Lens Icon Template](http://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/lens_icon_template_illustrator.zip)

Open the template within Adobe Illustrator. Replace the content in the
layer labeled `[REPLACE ME]`. This layer has a clipping mask which masks
the content to a circle. Additionally, you can tune the background color
by adjusting the color of the `Frame BG` layer.

![Creating an Icon
Layers](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/Guides/img/creating_an_icon_world_ai_layers.png)

To export your icon, select `File -> Export -> Export for Screens` and
select `PNG` as the export format.

![](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/Guides/img/creating_an_icon_world_ai_export.png)

## Adding the Icon to the Lens

The icon is added to the Lens via the `Project Info` settings window.
For more information on editing project info, please refer to the
[Configuring Project Info](/guides/submission/configuring-project-info)
guide.

**Note  
**When an icon is imported into Lens Studio, the white border is
automatically added and the image is cropped to a circle. If you don't
have Photoshop or Illustrator, you can still create a Lens icon. Create
a 320 x 320 pixel PNG in the image editing software of your choice. The
border and circle shape will be applied automatically after importing
the square image as the icon  
