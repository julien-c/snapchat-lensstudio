...
If you see a Snapcode with a circle in the center, that means it can
unlock a World Lens. You can even share these Lenses with friends so
...
If you see a Snapcode with a circle in the center, scan it\! It might
have a special Lens inside you can use for a limited time.

**To scan and unlock a Lens from a Snapcode...**
...
1.  Click the link\! 
2.  If you're in Snapchat, you will be prompted to unlock the lens
3.  If you're on your mobile device, Snapchat will automatically open
    and prompt you to unlock the Lens
4.  If you're on a non-mobile device, you'll be taken to a webpage
    displaying the Snapcode.

![](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/lens_link_example.png)

### Unlock a Lens From Your Camera Roll 

You can also scan Snapcodes right from your Camera Roll, in case you
aren’t able to point your camera right at it. This works for all kinds
of Snapcodes\!

**To scan and unlock a Snapcode from your Camera Roll…**

1.  **Tap the Profile icon **in the top-left to go to your Profile
    screen 
2.  **Tap the Settings icon** in the top right 
3.  Tap ‘**Snapcodes**’
4.  Tap **'Scan from Camera Roll'**
5.  **Select a picture** with a Snapcode in it\!

![](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/lens_friend_example.png)

### Unlock a Lens You See in a Snap 

If you see a fun-looking Lens in a friend's Snap or somewhere else on
Snapchat, you might be able unlock it yourself\!
...
![](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/lens_swipe_example.png)

### Sharing a Lens with a Friend 

**To share a Lens you’ve unlocked with a friend…**

1.  **Go to the Camera screen**, and **tap anywhere** to launch Lenses 

2.  **Swipe over** to the Lens you want to share

3.  **Tap the ⓘ button** above the Lens button to bring up more info

4.  Tap ‘**Send To Friends**’ to share the Lens with friends over Chat\!

## Related Guides

Please refer to the guides below for additional information:

  - [Sharing Your Snapcode](/guides/sharing/snapcodes)
