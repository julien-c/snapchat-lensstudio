...
The High Score Template is a more complex example of the persistent
storage system. Please refer to the [Simple High Score
Template](/templates/interactive/simple-high-score) which walks through
the persistent storage functionality that drives the High Score
template.

![](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/Templates/T2kuv7A_2_0_0/img/high_score_example.gif)
