...
Latest updates 2019-04-04

The API is a complete Javascript reference for scripting inside Lens
Studio. The API includes many features of Lens Studio not covered in the
guides, so be sure to check it out\!
...
If this is your first time scripting using Lens Studio, make sure to
check out the Scripting Overview guide which presents a high level
walkthrough of the scripting system.
...
The Debugging guide walks you through how to debug your scripts both in
Lens Studio and on device.

# 

## API

  - [Classes](/api/classes/SceneObject) - A collection of every class in
    the API
  - [Assets](/api/Assets) - A listing of all Asset types. Assets are
    resources imported into Lens Studio
  - [Components](/api/Components) - A listing of all Components.
    Components define object behavior
  - [Events](/api/Events) - A list of all Event types. Events can
    trigger code to run when certain things occur
  - [Global Methods](/api/GlobalMethods) - Listing of methods in the
    global scope
  - [Global Properties](/api/GlobalProperties) - Listing of properties
    in the global scope
  - [Scripting Input Types](/api/InputTypes) - Script inputs allow you
    to set script variables from the Inspector

![hello\_world\_api\_small.png\#asset:3426](https://storage.googleapis.com/snapchat-lens-assets/f1a09194-f02d-43ed-92b8-62e843179ff0/lensStudio/hello_world_api_small.png)  
