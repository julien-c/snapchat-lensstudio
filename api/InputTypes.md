...
See also: [Scripting Overview](/guides/scripting/scripting-overview),
[Custom Script UI](/guides/scripting/custom-script-ui).

| Input                    | Type                                          |
| ------------------------ | --------------------------------------------- |
| `//@input SceneObject`   | [`SceneObject`](/api/classes/SceneObject)     |
| `//@input float`         | `Number`                                      |
| `//@input int`           | `Number`                                      |
| `//@input bool`          | `Boolean`                                     |
| `//@input vec2`          | [`vec2`](/api/classes/vec2)                   |
| `//@input vec3`          | [`vec3`](/api/classes/vec3)                   |
| `//@input vec4`          | [`vec4`](/api/classes/vec4)                   |
| `//@input mat2`          | [`mat2`](/api/classes/mat2)                   |
| `//@input mat3`          | [`mat3`](/api/classes/mat3)                   |
| `//@input mat4`          | [`mat4`](/api/classes/mat4)                   |
| `//@input quat`          | [`quat`](/api/classes/quat)                   |
| `//@input string`        | `String`                                      |
| `//@input SceneObject[]` | [`SceneObject`](/api/classes/SceneObject)\[\] |
| `//@input float[]`       | `Number[]`                                    |
| `//@input bool[]`        | `Boolean[]`                                   |
...
In addition, [Component types](/api/Components) and [Asset
types](/api/Assets) can be used.
