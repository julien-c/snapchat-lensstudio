...
Assets are resources imported into Lens Studio. These are the different
Asset types available in the scripting API. See also: [Importing and
Updating Resources
Guide](/guides/general/importing-and-updating-resources)

| Class Name                                            | Scripting Name            |
| ----------------------------------------------------- | ------------------------- |
| [`AnimationLayer`](/api/classes/AnimationLayer)       | `Asset.AnimationLayer`    |
| [`AudioEffectAsset`](/api/classes/AudioEffectAsset)   | `Asset.AudioEffectAsset`  |
| [`AudioTrackAsset`](/api/classes/AudioTrackAsset)     | `Asset.AudioTrackAsset`   |
| [`BinAsset`](/api/classes/BinAsset)                   | `Asset.BinAsset`          |
| [`Font`](/api/classes/Font)                           | `Asset.Font`              |
| [`MarkerAsset`](/api/classes/MarkerAsset)             | `Asset.MarkerAsset`       |
| [`Material`](/api/classes/Material)                   | `Asset.Material`          |
| [`ObjectPrefab`](/api/classes/ObjectPrefab)           | `Asset.ObjectPrefab`      |
| [`RenderMesh`](/api/classes/RenderMesh)               | `Asset.RenderMesh`        |
| [`SegmentationModel`](/api/classes/SegmentationModel) | `Asset.SegmentationModel` |
| [`Texture`](/api/classes/Texture)                     | `Asset.Texture`           |
