...
Methods available in the global scope. These methods can be called from
...
Returns the time difference in seconds between the current frame and
previous frame.
...
### `static isNull(object object)` : `Boolean`

Returns true if the passed in object is null or destroyed. Useful as a
safe way to check if a SceneObject or Component has been destroyed.

-----

### `static print(object ref)` : `void`
