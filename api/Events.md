...
Events are triggered by certain criteria and can be bound in script to
execute code. These are the different Event types available in the
scripting API. See also: [Script Events
Guide](/guides/scripting/script-events),
[ScriptComponent](/api/classes/ScriptComponent)

| Class Name                                                              | Scripting Name               |
| ----------------------------------------------------------------------- | ---------------------------- |
| [`BrowsLoweredEvent`](/api/classes/BrowsLoweredEvent)                   | `BrowsLoweredEvent`          |
| [`BrowsRaisedEvent`](/api/classes/BrowsRaisedEvent)                     | `BrowsRaisedEvent`           |
| [`BrowsReturnedToNormalEvent`](/api/classes/BrowsReturnedToNormalEvent) | `BrowsReturnedToNormalEvent` |
| [`CameraBackEvent`](/api/classes/CameraBackEvent)                       | `CameraBackEvent`            |
| [`CameraFrontEvent`](/api/classes/CameraFrontEvent)                     | `CameraFrontEvent`           |
| [`DelayedCallbackEvent`](/api/classes/DelayedCallbackEvent)             | `DelayedCallbackEvent`       |
| [`FaceFoundEvent`](/api/classes/FaceFoundEvent)                         | `FaceFoundEvent`             |
| [`FaceLostEvent`](/api/classes/FaceLostEvent)                           | `FaceLostEvent`              |
| [`FaceTrackingEvent`](/api/classes/FaceTrackingEvent)                   | `FaceTrackingEvent`          |
| [`KissFinishedEvent`](/api/classes/KissFinishedEvent)                   | `KissFinishedEvent`          |
| [`KissStartedEvent`](/api/classes/KissStartedEvent)                     | `KissStartedEvent`           |
| [`LateUpdateEvent`](/api/classes/LateUpdateEvent)                       | `LateUpdateEvent`            |
| [`ManipulateEndEvent`](/api/classes/ManipulateEndEvent)                 | `ManipulateEndEvent`         |
| [`ManipulateStartEvent`](/api/classes/ManipulateStartEvent)             | `ManipulateStartEvent`       |
| [`MouthClosedEvent`](/api/classes/MouthClosedEvent)                     | `MouthClosedEvent`           |
| [`MouthOpenedEvent`](/api/classes/MouthOpenedEvent)                     | `MouthOpenedEvent`           |
| [`SceneEvent`](/api/classes/SceneEvent)                                 | `SceneEvent`                 |
| [`SceneObjectEvent`](/api/classes/SceneObjectEvent)                     | `SceneObjectEvent`           |
| [`SmileFinishedEvent`](/api/classes/SmileFinishedEvent)                 | `SmileFinishedEvent`         |
| [`SmileStartedEvent`](/api/classes/SmileStartedEvent)                   | `SmileStartedEvent`          |
| [`SurfaceTrackingResetEvent`](/api/classes/SurfaceTrackingResetEvent)   | `SurfaceTrackingResetEvent`  |
| [`TapEvent`](/api/classes/TapEvent)                                     | `TapEvent`                   |
| [`TouchEndEvent`](/api/classes/TouchEndEvent)                           | `TouchEndEvent`              |
| [`TouchMoveEvent`](/api/classes/TouchMoveEvent)                         | `TouchMoveEvent`             |
| [`TouchStartEvent`](/api/classes/TouchStartEvent)                       | `TouchStartEvent`            |
| [`TurnOffEvent`](/api/classes/TurnOffEvent)                             | `TurnOffEvent`               |
| [`TurnOnEvent`](/api/classes/TurnOnEvent)                               | `TurnOnEvent`                |
| [`UpdateEvent`](/api/classes/UpdateEvent)                               | `UpdateEvent`                |
