...
Types of weather returned by
[UserContextSystem’s](/api/classes/UserContextSystem)
`requestWeatherCondition()` callback.

| Enum Value                       | Description                              |
| -------------------------------- | ---------------------------------------- |
| `WeatherCondition.Unknown`       | Unknown or unsupported weather condition |
