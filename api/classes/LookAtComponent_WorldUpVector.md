...
<!-- end list -->
  ...
  - [API](/api)
  - [Classes](/api/classes)
  - LookAtComponent\_WorldUpVector
...
Used with [LookAtComponent](/api/classes/LookAtComponent) to set the
“up” vector when determining rotation.

| Enum Value                              | Description               |
| --------------------------------------- | ------------------------- |
| `LookAtComponent.WorldUpVector.SceneX`  | Scene’s X vector          |
| `LookAtComponent.WorldUpVector.SceneY`  | Scene’s Y vector          |
| `LookAtComponent.WorldUpVector.SceneZ`  | Scene’s Z vector          |
| `LookAtComponent.WorldUpVector.TargetX` | Target object’s X vector  |
| `LookAtComponent.WorldUpVector.TargetY` | Target object’s Y vector  |
| `LookAtComponent.WorldUpVector.TargetZ` | Target object’s Z vector  |
| `LookAtComponent.WorldUpVector.ObjectX` | Current object’s X vector |
| `LookAtComponent.WorldUpVector.ObjectY` | Current object’s Y vector |
| `LookAtComponent.WorldUpVector.ObjectZ` | Current object’s Z vector |
