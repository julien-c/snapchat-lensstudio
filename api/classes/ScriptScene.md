...
### `createSceneObject(String name)` : [`SceneObject`](/api/classes/SceneObject)

Adds a new [SceneObject](/api/classes/SceneObject) named `name` to the
scene.
...
### `getRootObject(Number index)` : [`SceneObject`](/api/classes/SceneObject)

Returns the root [SceneObject](/api/classes/SceneObject) at index
`index` in the current scene.

-----

### `getRootObjectsCount()` : `Number`

Returns the number of [SceneObjects](/api/classes/SceneObject) in the
current scene.
