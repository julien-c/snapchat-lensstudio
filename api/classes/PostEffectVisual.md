...
Uses an input color lookup table image to adjust the coloring of the
Lens. See the [Color Correction Post Effect
guide](/guides/2d/post-effect/#color-correction) for more information.
