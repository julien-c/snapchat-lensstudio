...
A 2D visual used for drawing texture assets. Commonly used with
[ScreenTransform](/api/classes/ScreenTransform) for drawing images on
the screen.
...
Where (-1, -1) is the bottom left corner, (0, 0) is the center, and (1,
1) is the top right corner of the Image.
