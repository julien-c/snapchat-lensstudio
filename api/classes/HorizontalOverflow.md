...
Options for wrapping text horizontally. Used by [Text
component’s](/api/classes/Text) `horizontalOverflow` property.

| Enum Value                    | Description                                                                    |
| ----------------------------- | ------------------------------------------------------------------------------ |
| `HorizontalOverflow.Overflow` | Text will continue drawing past horizontal boundaries.                         |
| `HorizontalOverflow.Truncate` | Text is clipped to the width of horizontal boundaries.                         |
| `HorizontalOverflow.Wrap`     | Text wraps when reaching horizontal boundaries and continues on the next line. |
