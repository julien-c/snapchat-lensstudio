...
Controls a text rendering texture. Can be accessed through the main
rendering pass on a [Label](/api/classes/Label) component. The
properties here mirror those on Label.
