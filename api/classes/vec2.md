...
### `new vec2(Number x, Number y)` : [`vec2`](/api/classes/vec2)
...
### `equal(vec2 vec)` : `Boolean`

Returns whether this is equal to `vec`.

-----

### `moveTowards(vec2 point, Number magnitude)` : [`vec2`](/api/classes/vec2)
...
### `mult(vec2 vec)` : [`vec2`](/api/classes/vec2)
...
### `scale(vec2 vec)` : [`vec2`](/api/classes/vec2)
...
### `sub(vec2 vec)` : [`vec2`](/api/classes/vec2)

Returns the vector minus `vec`.

-----

### `uniformScale(Number scale)` : [`vec2`](/api/classes/vec2)
...
### `static lerp(vec2 vecA, vec2 vecB, Number t)` : [`vec2`](/api/classes/vec2)
...
### `static max(vec2 vecA, vec2 vecB)` : [`vec2`](/api/classes/vec2)
...
### `static min(vec2 vecA, vec2 vecB)` : [`vec2`](/api/classes/vec2)
