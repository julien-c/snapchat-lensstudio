...
Inherits from [IEventParameters](/api/classes/IEventParameters)

Child Classes: [`CameraBackEvent`](/api/classes/CameraBackEvent),
[`CameraFrontEvent`](/api/classes/CameraFrontEvent),
[`DelayedCallbackEvent`](/api/classes/DelayedCallbackEvent),
[`FaceTrackingEvent`](/api/classes/FaceTrackingEvent),
[`LateUpdateEvent`](/api/classes/LateUpdateEvent),
...
The base class for scenewide events. SceneEvents can be created using
[ScriptComponent](/api/classes/ScriptComponent)’s
[createEvent](/api/classes/ScriptComponent#createeventstring-eventtype-sceneevent)
method.
