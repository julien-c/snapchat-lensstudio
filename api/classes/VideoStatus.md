...
| ----------------------- | ------------------------------ |
| `VideoStatus.Stopped`   | The video playback has stopped |
| `VideoStatus.Preparing` | The video is being prepared    |
| `VideoStatus.Playing`   | The video is playing           |
| `VideoStatus.Paused`    | The video playback is paused   |
