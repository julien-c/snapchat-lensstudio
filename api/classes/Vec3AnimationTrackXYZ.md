...
Inherits from [Vec3AnimationTrack](/api/classes/Vec3AnimationTrack)
...
### `getChildTrackByIndex(Number index)` : [`AnimationTrack`](/api/classes/AnimationTrack)

Returns the child track at index `index`

-----

### `setChildTrackByIndex(Number index, AnimationTrack track)` : `void`
