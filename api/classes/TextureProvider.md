...
Inherits from [Resource](/api/classes/Resource)
...
The base class for specialized Texture providers. Can be accessed
through [Texture.control](/api/classes/Texture#control-textureprovider).
