...
Inherits from [SceneObjectEvent](/api/classes/SceneObjectEvent)
...
### `getTouchPosition()` : [`vec2`](/api/classes/vec2)

Returns the normalized 2D screen position of the user’s touch. The
normalized coordinates range from (\[0-1\], \[0-1\]), (0,0) being
top-left and (1,1) being bottom-right.
