...
Types of screen regions that can be used with
[ScreenRegionComponent](/api/classes/ScreenRegionComponent).

| Enum Value                     | Description                                                                                                           |
| ------------------------------ | --------------------------------------------------------------------------------------------------------------------- |
| `ScreenRegionType.FullFrame`   | The entire screen area of the device.                                                                                 |
| `ScreenRegionType.Capture`     | The screen area shown to the user when recording. On some devices, this region is a subset of FullFrame region.       |
| `ScreenRegionType.Preview`     | The screen area shown to the user when previewing a Snap. On some devices, this region is a subset of Capture region. |
| `ScreenRegionType.SafeRender`  | A screen area that will be visible on all devices and won’t overlap Snapchat UI. Safe area to place any UI elements.  |
| `ScreenRegionType.RoundButton` | The screen area where the round “Snap” button is drawn.                                                               |
