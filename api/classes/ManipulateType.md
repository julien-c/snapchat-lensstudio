...
Enum values specifying each type of manipulation. See
[ManipulateComponent](/api/classes/ManipulateComponent).

| Enum Value              | Description                                              |
| ----------------------- | -------------------------------------------------------- |
| `ManipulateType.Scale`  | The object can be scaled by pinching with two fingers.   |
| `ManipulateType.Swivel` | The object can be rotated by swiveling with two fingers. |
| `ManipulateType.Drag`   | The object can be moved by touching and dragging.        |
