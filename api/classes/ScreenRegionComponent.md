...
Overrides the settings on a local
[ScreenTransform](/api/classes/ScreenTransform) to fit a screen region
on the device. See the [Screen Transform
guide](/guides/2d/screen-transform) for more information.

## Properties

-----

### `region` : [`ScreenRegionType`](/api/classes/ScreenRegionType)

The region of the screen the local
[ScreenTransform](/api/classes/ScreenTransform) will be fit to.
