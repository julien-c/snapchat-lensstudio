...
Used to add an audio effect to a Lens. When present in the scene, it
will automatically apply the selected audio effect to recordings made
with the Lens. See the [Audio Effect](/guides/audio-effect) guide for
more information.
