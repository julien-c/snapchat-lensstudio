...
### `new mat3()` : [`mat3`](/api/classes/mat3)
...
### `add(mat3 y)` : [`mat3`](/api/classes/mat3)
...
### `div(mat3 y)` : [`mat3`](/api/classes/mat3)

Returns the result of dividing the two matrices.

-----

### `equal(mat3 other)` : `Boolean`

Returns whether the two matrices are equal.

-----

### `inverse()` : [`mat3`](/api/classes/mat3)

Returns the inverse of the matrix.

-----

### `mult(mat3 y)` : [`mat3`](/api/classes/mat3)

Returns the result of multiplying the two matrices.

-----

### `multiplyScalar(Number s)` : [`mat3`](/api/classes/mat3)

Returns the result of scalar multiplying the matrix.

-----

### `sub(mat3 y)` : [`mat3`](/api/classes/mat3)

Returns the result of subtracting the two matrices.

-----

### `transpose()` : [`mat3`](/api/classes/mat3)

Returns the transpose of this matrix.

-----

### `static add(mat3 arg1, mat3 arg2)` : [`mat3`](/api/classes/mat3)

Returns the result of adding the two matrices together.

-----

### `static div(mat3 arg1, mat3 arg2)` : [`mat3`](/api/classes/mat3)

Returns the result of dividing the two matrices.

-----

### `static identity()` : [`mat3`](/api/classes/mat3)

Returns the identity matrix.

-----

### `static makeFromRotation(quat arg1)` : [`mat3`](/api/classes/mat3)

Returns a matrix representing the specified rotation.

-----

### `static mul(mat3 arg1, mat3 arg2)` : [`mat3`](/api/classes/mat3)

Returns the result of multiplying the two matrices.

-----

### `static sub(mat3 arg1, mat3 arg2)` : [`mat3`](/api/classes/mat3)

Returns the result of subtracting the two matrices.

-----

### `static zero()` : [`mat3`](/api/classes/mat3)
...
### `column0` : [`vec3`](/api/classes/vec3)

The first column of the matrix.

-----

### `column1` : [`vec3`](/api/classes/vec3)

The second column of the matrix.

-----

### `column2` : [`vec3`](/api/classes/vec3)
