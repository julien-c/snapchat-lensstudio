...
Possible index data types used by
[MeshBuilder](/api/classes/MeshTopology). `MeshIndexType.UInt16` is the
value normally used.

| Enum Value             | Description                                       |
| ---------------------- | ------------------------------------------------- |
| `MeshIndexType.None`   | No index data type                                |
| `MeshIndexType.UInt16` | Unsigned integer, this is the value normally used |
