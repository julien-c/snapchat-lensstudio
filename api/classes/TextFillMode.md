...
Used in [TextFill’s](/api/classes/TextFill) `mode` property. Controls
which drawing method is used for the TextFill.

| Enum Value             | Description                             |
| ---------------------- | --------------------------------------- |
| `TextFillMode.Solid`   | Solid color will be used for drawing.   |
| `TextFillMode.Texture` | Tiled texture will be used for drawing. |
