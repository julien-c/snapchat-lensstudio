...
Provides information about the user such as display name, birthday, and
current weather. Accessible through `global.userContextSystem`.

All callbacks will execute as soon as the requested information is
available. In some rare cases, the requested information may be
completely unavailable, and the callback will never occur.
...
### `requestAltitudeFormatted(function(String) callback)` : `void`

Provides the user’s current altitude as a localized string.

-----

### `requestAltitudeInMeters(function(Number) callback)` : `void`

Provides the user’s current altitude in meters.

-----

### `requestBirthdate(function(Date) callback)` : `void`

Provides the user’s birth date as a Date object.

-----

### `requestBirthdateFormatted(function(String) callback)` : `void`

Provides the user’s birth date as localized string.

-----

### `requestCity(function(String) callback)` : `void`

Provides the name of the city the user is currently located in.

-----

### `requestDisplayName(function(String) callback)` : `void`

Provides the user’s display name.

-----

### `requestTemperatureCelsius(function(Number) callback)` : `void`

Provides the user’s current temperature in celsius.

-----

### `requestTemperatureFahrenheit(function(Number) callback)` : `void`

Provides the user’s current temperature in fahrenheit.

-----

### `requestTemperatureFormatted(function(String) callback)` : `void`

Provides the user’s current temperature as a localized string.

-----

### `requestWeatherCondition(function(WeatherCondition) callback)` : `void`

Provdes the user’s current weather condition.

-----

### `requestWeatherLocalized(function(String) callback)` : `void`
