...
Used with [Pass’s](/api/classes/Pass) `cullMode` property. Determines
which faces of a surface are culled (not rendered).

| Enum Value              | Description                                                 |
| ----------------------- | ----------------------------------------------------------- |
| `CullMode.Front`        | Front facing surfaces are not rendered.                     |
| `CullMode.Back`         | Back facing surfaces are not rendered.                      |
| `CullMode.FrontAndBack` | Neither front facing nor back facing surfaces are rendered. |
