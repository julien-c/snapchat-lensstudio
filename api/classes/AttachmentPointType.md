...
Used by [Head.setAttachmentPointType()](/api/classes/Head) to specify
the type of attachment used with a Head binding.

| Enum Value                                | Description         |
| ----------------------------------------- | ------------------- |
| `AttachmentPointType.HeadCenter`          | HeadCenter          |
| `AttachmentPointType.CandideCenter`       | CandideCenter       |
| `AttachmentPointType.TriangleBarycentric` | TriangleBarycentric |
