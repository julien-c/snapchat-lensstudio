...
setting animation clip range type.

| Enum Value                       | Description                                          |
| -------------------------------- | ---------------------------------------------------- |
| `AnimationClip.RangeType.Time`   | Range is specified by start and end time, in seconds |
| `AnimationClip.RangeType.Frames` | Range is specified by start and end frame numbers    |
