...
Used by [AnimationMixerLayer](/api/classes/AnimationMixerLayer) for
setting animation looping behavior.

| Enum Value                             | Description                                                                       |
| -------------------------------------- | --------------------------------------------------------------------------------- |
| `AnimationClip.PostInfinity.Cycle`     | The animation will restart from the beginning each time it loops.                 |
| `AnimationClip.PostInfinity.Oscillate` | The animation will switch between normal and reverse playback each time it loops. |
