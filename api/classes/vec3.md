...
### `new vec3(Number x, Number y, Number z)` : [`vec3`](/api/classes/vec3)
...
### `equal(vec3 vec)` : `Boolean`

Returns whether this is equal to `vec`.

-----

### `moveTowards(vec3 point, Number magnitude)` : [`vec3`](/api/classes/vec3)

Returns a copy of the vector moved towards the point `point` by the
amount `magnitude`.

-----

### `mult(vec3 vec)` : [`vec3`](/api/classes/vec3)

Returns the component-wise multiplication product of the vector and
`vec`.

-----

### `normalize()` : [`vec3`](/api/classes/vec3)

Returns a copy of the vector with its length scaled to 1.

-----

### `project(vec3 vec)` : [`vec3`](/api/classes/vec3)

Returns a copy of the vector projected onto the vector `vec`.

-----

### `projectOnPlane(vec3 normal)` : [`vec3`](/api/classes/vec3)

Projects the vector onto the plane represented by the normal `normal`.

-----

### `reflect(vec3 vec)` : [`vec3`](/api/classes/vec3)

Returns a copy of the vector reflected across the plane defined by the
normal `vec`.

-----

### `rotateTowards(vec3 point, Number amount)` : [`vec3`](/api/classes/vec3)

Returns a copy of the vector rotated towards the point `point` by
`amount`.

-----

### `scale(vec3 vec)` : [`vec3`](/api/classes/vec3)
...
### `sub(vec3 vec)` : [`vec3`](/api/classes/vec3)

Returns the vector minus `vec`.

-----

### `uniformScale(Number scale)` : [`vec3`](/api/classes/vec3)

Multiplies the components by the number `scale`.

-----

### `static back()` : [`vec3`](/api/classes/vec3)

Returns the vector (0, 0, -1).

-----

### `static down()` : [`vec3`](/api/classes/vec3)

Returns the vector (0, -1, 0).

-----

### `static forward()` : [`vec3`](/api/classes/vec3)

Returns the vector (0, 0, 1).

-----

### `static left()` : [`vec3`](/api/classes/vec3)

Returns the vector (-1, 0, 0).

-----

### `static lerp(vec3 vecA, vec3 vecB, Number t)` : [`vec3`](/api/classes/vec3)

Linearly interpolates between the two vectors `vecA` and `vecB` by the
factor `t`.

-----

### `static max(vec3 vecA, vec3 vecB)` : [`vec3`](/api/classes/vec3)

Compares the vectors `vecA` and `vecB`. Returns the vector with the
larger magnitude.

-----

### `static min(vec3 vecA, vec3 vecB)` : [`vec3`](/api/classes/vec3)
...
### `static one()` : [`vec3`](/api/classes/vec3)

Returns the vector (1, 1, 1).

-----

### `static orthonormalize(vec3 vecA, vec3 vecB)` : `void`

Makes the vectors `vecA` and `vecB` normalized and orthogonal to each
other.

-----

### `static right()` : [`vec3`](/api/classes/vec3)

Returns the vector (1, 0, 0).

-----

### `static slerp(vec3 vecA, vec3 vecB, Number t)` : [`vec3`](/api/classes/vec3)

Spherically interpolates between the two vectors `vecA` and `vecB` by
the factor `t`.

-----

### `static up()` : [`vec3`](/api/classes/vec3)
