...
A reusable object hierarchy stored as a resource. Can be instantiated
through script or brought into the scene through Lens Studio. For more
information, see the [Prefabs](/guides/general/prefabs) guide.

## Methods

-----

### `instantiate(SceneObject parent)` : [`SceneObject`](/api/classes/SceneObject)

Creates and returns a new instance of this object hierarchy underneath
the specified parent object. If parent is null, the object will be
