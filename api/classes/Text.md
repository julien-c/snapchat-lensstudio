...
Visual component that renders dynamic text. See the [Text
guide](/guides/2d/text) for more information.

## Properties

-----

### `dropshadowSettings` : [`DropshadowSettings`](/api/classes/DropshadowSettings)

Settings for how dropshadow is used in text drawing.

-----

### `font` : [`Font`](/api/classes/Font)

Font asset used.

-----

### `horizontalOverflow` : [`HorizontalOverflow`](/api/classes/HorizontalOverflow)

Controls how text should be handled when it goes past the horizontal
boundaries.

-----

### `outlineSettings` : [`OutlineSettings`](/api/classes/OutlineSettings)
...
### `textFill` : [`TextFill`](/api/classes/TextFill)

Settings for how the text is drawn, such as fill color or texture.

-----

### `verticalOverflow` : [`VerticalOverflow`](/api/classes/VerticalOverflow)

Controls how text should be handled when it goes past the vertical
boundaries.
