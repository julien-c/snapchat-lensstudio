...
Applies a face stretch effect. Face stretch features can be added to a
FaceStretchVisual through the Inspector panel in Lens Studio. See the
[Face Stretch Guide](/guides/face/face-effects/face-stretch) for more
information.
...
### `getFeatureWeight(String feature)` : `Number`

Returns the weight of the face stretch feature named `feature`.

-----

### `setFeatureWeight(String feature, Number intensity)` : `void`

Sets the weight of the face stretch feature named `feature` to
