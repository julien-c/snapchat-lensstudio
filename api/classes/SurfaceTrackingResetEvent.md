...
Scripting Name: `SurfaceTrackingResetEvent`

Inherits from [SceneEvent](/api/classes/SceneEvent)

## Description

If a [DeviceTracking](/api/classes/DeviceTracking) component is present
in the scene, this event is triggered when the tracking is restarted
(typically when the Lens starts, or if the user taps the ground). Note:
This class was named “WorldTrackingResetEvent” prior to Snapchat v10.32.
...
## Examples
    ...
    var surfaceTrackingResetEvent = script.createEvent("SurfaceTrackingResetEvent");
    surfaceTrackingResetEvent.bind(onSurfaceReset);
