...
Represents transform data for screen-aligned 2D sprites. Use on
SceneObjects with a SpriteVisual Component. See also:
[SpriteVisual](/api/classes/SpriteVisual).
...
### `bindingPoint` : [`vec2`](/api/classes/vec2)

The location of the point this sprite is bound to.

-----

### `size` : [`vec2`](/api/classes/vec2)
