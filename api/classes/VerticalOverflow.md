...
Options for handling vertical text overflow. Used by [Text
component’s](/api/classes/Text) `verticalOverflow` property.

| Enum Value                  | Description                                                       |
| --------------------------- | ----------------------------------------------------------------- |
| `VerticalOverflow.Overflow` | Text will continue to draw past the end of the vertical boundary. |
| `VerticalOverflow.Truncate` | Text will be clipped at the end of the vertical boundary.         |
