...
Used by
[DeviceLocationTrackingComponent](/api/classes/DeviceLocationTrackingComponent)
to indicate the user’s distance from the landmarker location. See the
[Landmarker guide](/templates/landmarker) for more information.

| Enum Value                            | Description                                                          |
| ------------------------------------- | -------------------------------------------------------------------- |
| `LocationProximityStatus.Unknown`     | User’s distance cannot be determined or has not been determined yet. |
| `LocationProximityStatus.WithinRange` | User is close enough to the landmarker location to begin tracking.   |
| `LocationProximityStatus.OutOfRange`  | User is too far away from the landmarker location to track it.       |
