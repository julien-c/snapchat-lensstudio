...
### `new mat2()` : [`mat2`](/api/classes/mat2)
...
### `add(mat2 y)` : [`mat2`](/api/classes/mat2)
...
### `div(mat2 y)` : [`mat2`](/api/classes/mat2)

Returns the result of dividing the two matrices.

-----

### `equal(mat2 other)` : `Boolean`

Returns whether the two matrices are equal.

-----

### `inverse()` : [`mat2`](/api/classes/mat2)

Returns the inverse of the matrix.

-----

### `mult(mat2 y)` : [`mat2`](/api/classes/mat2)

Returns the result of multiplying the two matrices.

-----

### `multiplyScalar(Number s)` : [`mat2`](/api/classes/mat2)

Returns the result of scalar multiplying the matrix.

-----

### `sub(mat2 y)` : [`mat2`](/api/classes/mat2)

Returns the result of subtracting the two matrices.

-----

### `transpose()` : [`mat2`](/api/classes/mat2)

Returns the transpose of this matrix.

-----

### `static add(mat2 arg1, mat2 arg2)` : [`mat2`](/api/classes/mat2)

Returns the result of adding the two matrices together.

-----

### `static div(mat2 arg1, mat2 arg2)` : [`mat2`](/api/classes/mat2)

Returns the result of dividing the two matrices.

-----

### `static identity()` : [`mat2`](/api/classes/mat2)

Returns the identity matrix.

-----

### `static mul(mat2 arg1, mat2 arg2)` : [`mat2`](/api/classes/mat2)

Returns the result of multiplying the two matrices.

-----

### `static sub(mat2 arg1, mat2 arg2)` : [`mat2`](/api/classes/mat2)

Returns the result of subtracting the two matrices.

-----

### `static zero()` : [`mat2`](/api/classes/mat2)
...
### `column0` : [`vec2`](/api/classes/vec2)

The first column of the matrix.

-----

### `column1` : [`vec2`](/api/classes/vec2)
