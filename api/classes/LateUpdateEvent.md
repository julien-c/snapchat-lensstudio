...
This event is triggered at the end of every frame, after normal
[UpdateEvents](/api/classes/UpdateEvent) trigger but before rendering
occurs.
...
Returns the time elapsed (in seconds) between the current frame and
previous frame.
