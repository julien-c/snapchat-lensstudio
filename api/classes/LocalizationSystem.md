...
Helps convert data types to localized string representations. Accessible
through `global.localizationSystem`.

Note that formatted or localized strings may appear differently to users
depending on their region. The example results given here are
representative of a user in the United States, but may appear
differently for users in other regions.
...
Returns a localized string for the day of the week of the passed in
`Date` object.
...
### `getFormattedDistanceFromMeters(Number meters)` : `String`

Returns a localized, formatted string representation of the distance in
meters passed in.
...
### `getFormattedSeconds(Number seconds)` : `String`

Returns a localized, formatted string representing the number of seconds
passed in.
...
### `getFormattedTemperatureFromCelsius(Number temperature)` : `String`

Returns a localized, formatted string representation of the celsius
...
### `getFormattedTemperatureFromFahrenheit(Number temperature)` : `String`

Returns a localized, formatted string representation of the fahrenheit
temperature passed in.
