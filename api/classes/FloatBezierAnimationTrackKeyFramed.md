...
Inherits from [FloatAnimationTrack](/api/classes/FloatAnimationTrack)

## Description

Represents an animation track using vec3 value keyframes for a bezier
curve.
...
### `addKey(Number time, vec3 value)` : `void`
