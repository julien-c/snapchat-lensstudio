...
Tracking modes used by the [DeviceTracking](/api/classes/DeviceTracking)
component to specify what type of tracking to use.

| Enum Value                    | Description                                  |
| ----------------------------- | -------------------------------------------- |
| `DeviceTrackingMode.Rotation` | Use gyroscope tracking (rotation only)       |
| `DeviceTrackingMode.Surface`  | Use surface tracking (position and rotation) |
| `DeviceTrackingMode.World`    | Use native tracking (position and rotation)  |
