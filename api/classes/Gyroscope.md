...
This class has been **Deprecated**. Please instead use the
[DeviceTracking](/api/classes/DeviceTracking) component with Tracking
Mode set to Rotation. See the [Tracking
Modes](/guides/general/tracking/tracking-modes) guide for more
information.

Applies the device’s gyroscope rotation to the SceneObject it is
attached to.
...
If enabled, the Gyroscope’s rotation will be inverted when the front
