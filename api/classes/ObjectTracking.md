...
Used to track objects in the camera. Moves the local
[ScreenTransform](/api/classes/ScreenTransform) to match the detected
image. See the [Object Tracking
guide](/guides/general/tracking/object-tracking) for more information.
...
If true, child objects of this Component’s
[SceneObject](/api/classes/SceneObject) will be disabled when the object
...
### `onObjectFound` : `function`

A function that gets called when the tracked object is found.

-----

### `onObjectLost` : `function`
