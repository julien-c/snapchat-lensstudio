...
[ManipulateComponent.intersectManipulateFrame()](/api/classes/ManipulateComponent).

## Methods

-----

### `getIntersectionPoint()` : [`vec3`](/api/classes/vec3)

If there was a valid intersection, returns the intersection point in
world space.
