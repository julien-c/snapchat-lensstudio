...
Components are attached to [SceneObjects](/api/classes/SceneObject) and
define object behavior. These are the Component types available in the
scripting API. See also: [Inspector
Panel](/guides/general/panels#inspector),
[SceneObject](/api/classes/SceneObject)

| Class Name                                                                        | Scripting Name                              |
| --------------------------------------------------------------------------------- | ------------------------------------------- |
| [`Animation`](/api/classes/Animation)                                             | `Component.Animation`                       |
| [`AnimationMixer`](/api/classes/AnimationMixer)                                   | `Component.AnimationMixer`                  |
| [`AudioComponent`](/api/classes/AudioComponent)                                   | `Component.AudioComponent`                  |
| [`AudioEffectComponent`](/api/classes/AudioEffectComponent)                       | `Component.AudioEffectComponent`            |
| [`BlendShapesVisual`](/api/classes/BlendShapesVisual)                             | `Component.BlendShapes`                     |
| [`Camera`](/api/classes/Camera)                                                   | `Component.Camera`                          |
| [`ClearDepth`](/api/classes/ClearDepth)                                           | `Component.ClearDepth`                      |
| [`DeviceLocationTrackingComponent`](/api/classes/DeviceLocationTrackingComponent) | `Component.DeviceLocationTrackingComponent` |
| [`DeviceTracking`](/api/classes/DeviceTracking)                                   | `Component.DeviceTracking`                  |
| [`EyeColorVisual`](/api/classes/EyeColorVisual)                                   | `Component.EyeColorVisual`                  |
| [`FaceInsetVisual`](/api/classes/FaceInsetVisual)                                 | `Component.FaceInsetVisual`                 |
| [`FaceMaskVisual`](/api/classes/FaceMaskVisual)                                   | `Component.FaceMaskVisual`                  |
| [`FaceStretchVisual`](/api/classes/FaceStretchVisual)                             | `Component.FaceStretchVisual`               |
| [`Gyroscope`](/api/classes/Gyroscope)                                             | `Component.Gyroscope`                       |
| [`Head`](/api/classes/Head)                                                       | `Component.Head`                            |
| [`HintsComponent`](/api/classes/HintsComponent)                                   | `Component.HintsComponent`                  |
| [`Image`](/api/classes/Image)                                                     | `Component.Image`                           |
| [`Label`](/api/classes/Label)                                                     | `Component.Label`                           |
| [`LightSource`](/api/classes/LightSource)                                         | `Component.LightSource`                     |
| [`LiquifyVisual`](/api/classes/LiquifyVisual)                                     | `Component.LiquifyVisual`                   |
| [`LookAtComponent`](/api/classes/LookAtComponent)                                 | `Component.LookAtComponent`                 |
| [`ManipulateComponent`](/api/classes/ManipulateComponent)                         | `Component.ManipulateComponent`             |
| [`MarkerTrackingComponent`](/api/classes/MarkerTrackingComponent)                 | `Component.MarkerTrackingComponent`         |
| [`MeshVisual`](/api/classes/MeshVisual)                                           | `Component.MeshVisual`                      |
| [`ObjectTracking`](/api/classes/ObjectTracking)                                   | `Component.ObjectTracking`                  |
| [`PinToMeshComponent`](/api/classes/PinToMeshComponent)                           | `Component.PinToMeshComponent`              |
| [`PostEffectVisual`](/api/classes/PostEffectVisual)                               | `Component.PostEffectVisual`                |
| [`RetouchVisual`](/api/classes/RetouchVisual)                                     | `Component.RetouchVisual`                   |
| [`ScreenRegionComponent`](/api/classes/ScreenRegionComponent)                     | `Component.ScreenRegionComponent`           |
| [`ScreenTransform`](/api/classes/ScreenTransform)                                 | `Component.ScreenTransform`                 |
| [`ScriptComponent`](/api/classes/ScriptComponent)                                 | `Component.ScriptComponent`                 |
| [`Skin`](/api/classes/Skin)                                                       | `Component.Skin`                            |
| [`SpriteAligner`](/api/classes/SpriteAligner)                                     | `Component.SpriteAligner`                   |
| [`SpriteVisual`](/api/classes/SpriteVisual)                                       | `Component.SpriteVisual`                    |
| [`Text`](/api/classes/Text)                                                       | `Component.Text`                            |
| [`TouchComponent`](/api/classes/TouchComponent)                                   | `Component.TouchComponent`                  |
| [`VertexCache`](/api/classes/VertexCache)                                         | `Component.VertexCache`                     |
| [`Visual`](/api/classes/Visual)                                                   | `Component.Visual`                          |
